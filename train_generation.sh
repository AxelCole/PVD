...
#SBATCH --job-name=train_DDPM_PVD_2xA100_params # Use the variable for the job name
#SBATCH --output=train_DDPM_PVD_2xA100_params_%j.out # Use the variable in the output file name
